...
function LineChart({
  allow_decimals = true, data, idx, line_width = 5, note = false, show_first_label = true, source, subtitle = false, suffix = '', title
}) {
      ...
      chart: {
        events: {
          load() {
            ...
            this.renderer.image(`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2022-africa_stat_day/' : './'}assets/img/unctad_logo.svg`, 5, 15, 80, 100).add();
          }
        },
        height: chartHeight,
        resetZoomButton: {
